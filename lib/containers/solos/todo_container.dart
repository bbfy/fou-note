...
class _TodoContainerState extends State<TodoContainer> {
  void todoChecked(Solo todo) {
    playButtonEffect();
    context.read<TodoProvider>().addTodoList(todo);
    context.read<DbSqliteProvider>().delSolo(todo);
  }
  ...
  Widget build(BuildContext context) {
    ...
    bool isChecked = context.watch<SoloProvider>().getsoloCheck(todo);
    ...
    Size containerSize = Size(widget.listViewWidth, ContainerStyles.height);
    ...
    return GestureDetector(
      ...
      onTap: () {
        showDialog(
          context: context,
          builder: (context) => containerStyles.getSoloUpdateDialog(solo: todo),
        );
      },
      child: Container(
